    ...
    <div className="flex min-h-screen bg-background">
      <aside className="sticky top-0 hidden h-screen w-[260px] shrink-0 flex-col self-start border-r border-sidebar-border bg-sidebar lg:flex">
        <div className="flex h-14 items-center gap-2 border-b border-sidebar-border px-4">
          <Link href="/admin" className="-m-1.5 flex items-center gap-2 rounded-md p-1.5 text-[length:var(--fs-12)] text-muted-foreground hover:text-foreground">
        ...
        <div className="border-b border-sidebar-border px-4 py-2.5">
          ...
          <p className="mt-0.5 truncate text-[length:var(--fs-13)] font-medium text-foreground">{user.role.name}</p>
        </div>
