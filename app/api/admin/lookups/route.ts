...
export async function GET() {
  ...
  const [legalTypes, gemiOffices, companyStatuses, prefectures, municipalities, vatCategories, businessTypes] = await Promise.all([
  ...
  return NextResponse.json({ legalTypes, gemiOffices, companyStatuses, prefectures, municipalities, vatCategories, businessTypes });
}
