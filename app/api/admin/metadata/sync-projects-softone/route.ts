...
import { syncProjects, syncFailureResponse, withResyncLock } from '@/lib/softone-sync/resync';

// Έργα (PRJC) → `SoftoneProject`.
...
export async function POST() {
  ...
  try {
    const r = await withResyncLock(u, ['projects'], () => syncProjects(u));
