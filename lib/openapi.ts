        ...
        properties: {
          mapped: {
            ...
            properties: {
              ...
              name: { type: 'string' },
              shortName: { type: 'string', nullable: true },
              doy: { type: 'string', nullable: true, description: 'Ονομασία Δ.Ο.Υ. (ΑΑΔΕ doy_descr)' },
              doyCode: { type: 'string', nullable: true, description: 'Επίσημος κωδικός Δ.Ο.Υ. ΑΑΔΕ (basic_rec.doy), π.χ. 1190' },
