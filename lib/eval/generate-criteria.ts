...
function buildSystemPrompt(): string {
  return [
    'Είσαι ειδικός σε ΕΣΠΑ/ευρωπαϊκά προγράμματα. Κάπου στον οδηγό υπάρχει το ΕΡΩΤΗΜΑΤΟΛΟΓΙΟ/ΣΥΣΤΗΜΑ ΑΞΙΟΛΟΓΗΣΗΣ:',
    'κριτήρια με βαρύτητες (στάθμιση), δείκτες/τύπους υπολογισμού, κλίμακες βαθμολόγησης (βαθμοί ανά τιμή δείκτη) και ελάχιστη συνολική βαθμολογία.',
    'ΨΑΞΕ ΣΕ ΟΛΟ ΤΟ ΚΕΙΜΕΝΟ — μπορεί να βρίσκεται οπουδήποτε: σε παραρτήματα (π.χ. Παράρτημα ΙΙΙ), σε ενότητες «Κριτήρια Αξιολόγησης/Βαθμολόγησης»,',
    'σε πίνακες, σε υποσημειώσεις ή διάσπαρτο σε διαφορετικά σημεία. Συγκέντρωσε ΟΛΑ τα βαθμολογούμενα κριτήρια από οπουδήποτε στον οδηγό.',
    'Εξήγαγέ τα ΠΙΣΤΑ όπως περιγράφονται. ΜΗΝ αντιστοιχίσεις σε πεδία/δικαιολογητικά — η αντιστοίχιση γίνεται ΑΡΓΟΤΕΡΑ χειροκίνητα.',
    '',
    ...
    res = await fetch(apiUrl, {
      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          { role: 'user', content: `Σάρωσε ΟΛΟ τον οδηγό και βρες όλα τα βαθμολογούμενα κριτήρια αξιολόγησης (οπουδήποτε: παραρτήματα, ενότητες, πίνακες). Δώσε τα κριτήρια. Κείμενο οδηγού:\n\n${text}` },
        ],
      }),
    });
