...
// Prisma-backed reads/writes for SupplierFieldRule (findActiveFieldRules, upsertFieldRule)
// live in ./field-rules-db.ts (SERVER ONLY) — this module must stay free of `@/lib/db`
// so it can be imported by lib/templates/schema.ts, which client components use.
