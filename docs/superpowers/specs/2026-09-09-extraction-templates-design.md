...
- **Αυτόματη σάρωση με διόρθωση μετά** (ερώτηση χρήστη — ναι): το «Ανίχνευση σημειώσεων» αποκτά δύο τρόπους, `marks` (μόνο κυκλωμένα/χειρόγραφα) και `all` (κάθε ζεύγος ετικέτα→τιμή της σελίδας, για καθαρά δείγματα). Και στους δύο, ο χρήστης διορθώνει/προσθέτει πριν την αποθήκευση.
