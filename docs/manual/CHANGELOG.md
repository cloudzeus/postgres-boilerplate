...
- Νέο endpoint `POST /api/admin/ocr/[id]/template-runs/[runId]/reread` (μόνο στην τελευταία εκτέλεση) — ξαναϋπολογίζει τα σήματα του πεδίου και το projection στο παραστατικό όπως και η διόρθωση τιμής, με audit και καταγραφή κόστους.
