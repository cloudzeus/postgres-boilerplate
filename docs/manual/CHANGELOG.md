...
- Προαιρετική μεταβλητή περιβάλλοντος **`GOOGLE_GEOCODING_API_KEY`** (αλλιώς χρησιμοποιείται το υπάρχον `GOOGLE_MAPS_API_KEY`) — όταν ορίζεται χρησιμοποιείται το Google Geocoding, αλλιώς το Nominatim (OpenStreetMap) χωρίς κλειδί.
